...
export default function AdminEmployee() {
  ...
  async function handleUpdate(e) {
    ...
    try {
      ...
      setRows((prev) =>
        prev.map((r) =>
          r.user_id === updatedRow.user_id || r.id === updatedRow.id
            ? updatedRow
            : r
        )
      );
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      setNotification({
        type: "success",
        message: `Employee "${newRow.name}" has been added successfully!`,
      });
      setTimeout(() => setNotification(null), 3000);
    } catch (err) {
      console.error(err);
  ...
  function openDeleteConfirmation(employee) {
    ...
    if (
      ...
      setNotification({
        type: "error",
        message: "You cannot delete your own account while you're logged in.",
      });
      setTimeout(() => setNotification(null), 4000);
      return;
    }
    ...
    <div className="admin-layout">
      <aside className={`admin-sidebar${isSidebarOpen ? " open" : ""}`}>
        ...
        <nav className="nav">
          ...
          <Link
            className={`nav-item${
              isActive("/admin/employee") ? " active" : ""
            }`}
            to="/admin/employee"
          >
            Employees
          ...
          <Link
            className={`nav-item${
              isActive("/admin/leave-requests") ? " active" : ""
            }`}
                ...
                filteredRows.map((r) => (
                  ...
                  >
                    ...
                    <div className="center" data-title="Status">
                      <span
                        className={`status ${
                          r.status === "Inactive" ? "danger" : "success"
                        }`}
                      >
                        {r.status}
                      </span>
                    ...
                    <div className="detail-row two">
                      <div className="detail-item">
                        ...
                        <input
                          ...
                          className={`detail-input ${
                            editFormErrors.first_name ? "error" : ""
                          }`}
                          required
                        />
                      ...
                      <div className="detail-item">
                        ...
                        <input
                          ...
                          className={`detail-input ${
                            editFormErrors.last_name ? "error" : ""
                          }`}
                          required
                        />
                      ...
                      <div className="biometric-right">
                        <input
                          ...
                          className={`detail-input fingerprint-input ${
                            formErrors.finger_template_id ? "error" : ""
                          }`}
